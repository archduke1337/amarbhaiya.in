/**
 * @fileoverview OAuthButtons — Google & GitHub OAuth sign-in buttons.
 * Uses Appwrite client SDK's createOAuth2Session for redirect-based OAuth.
 */
"use client"
...
export function OAuthButtons() {
  ...
  function handleOAuth(provider: OAuthProvider, label: string) {
    ...
    const successUrl = `${window.location.origin}/app/dashboard`
